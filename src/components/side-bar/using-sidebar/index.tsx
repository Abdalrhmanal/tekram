...
export const menuItemsAll: MenuItem[] = [
  ...
  },
  {
    ...
    role: "all",
    children: [
      { text: "Customers", href: "/customers", logo: <PersonOutline />, isActive: false, role: "site-admin" },
      { text: "Service Providers", href: "/service-providers", logo: <GroupWorkOutlined />, isActive: false, role: "site-admin" },
      { text: "Account SProv", href: "/account-s-prov", logo: <GroupWorkOutlined />, isActive: false, role: "site-admin" },
      { text: "VIP Service Providers", href: "/vip-s-prov", logo: <GroupWorkOutlined />, isActive: false, role: "site-admin" },
      { text: "New Service Requests", href: "/new-request-service", logo: <GroupWorkOutlined />, isActive: false, role: "site-admin" },
    ],
  },
  {

...
function DrawerSettingUser({ avatar, fullName, email, onCloseDrawer }: { avatar?: string, fullName?: string, email?: string; onCloseDrawer?: () => void; }) {
...
export default DrawerSettingUser
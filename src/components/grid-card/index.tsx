...
import { ComparisonOperator, FilterType, GlobalDataType, GridTableProps } from "../data-table2/type/type";
import StructureTable from "../data-table2/structure-table";
import StructureCard from "./structure-card";

const GridCard: React.FC<GridTableProps> = ({
    dataSourceName,
    columns,
    onActionClick,
    onDelete,
